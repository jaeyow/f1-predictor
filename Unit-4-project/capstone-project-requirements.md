...
Describe your chosen problem and state whether you have access to relevant data. If you are stuck or need some inspiration, [see this list of curated datasets and links](./suggestions.md). Feel free to create a channel on Slack (Paddy can help you do that) if you want to discuss amongst your colleagues.
...
4. Draft your problem statement in a markdown file similar to this one, but limit yourself to 1-2 A4 sized pages (single spaced)


#### Submission
- Submit or share your project proposal before the beginning of session 9 i.e. 15th November
---
...
Exploratory data analysis is a crucial step in any data workflow. Create a Jupyter Lab Notebook that explores your data mathematically and visually. Explore features, apply descriptive statistics, look at distributions, and determine how to handle sampling or any missing values.
...
#### Submission
- Submit or share your project brief at the end of session 14 i.e. 1st December.
...
#### Requirements
1. A detailed Jupyter Lab Notebook with a summary of your analysis, approach, and evaluation metrics.
...
#### Submission
- Submit or share your project brief at the beginning of session 20 i.e. your final session.

---

<a name="presentation"></a>
## Final Project, Part 4: *Presentation*
> Summarise and present your findings.

Present your findings to an audience that may include non-technical executive stakeholders. Summarise and break down your problem, approach, and recommendations in a manner that different levels of expertise will find informative and persuasive.
